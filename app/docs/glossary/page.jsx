...
export default function Page(){
  return (
    <div className="card">
      ...
      <h1 className="h1" style={{fontSize:34}}>Compliance glossary</h1>
      ...
      <div className="small" style={{marginTop:10}}>Also on <a href="/compliance" style={{textDecoration:"underline"}}>/compliance</a></div>
    </div>
  );
}
